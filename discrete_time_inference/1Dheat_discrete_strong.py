...
class PhysicsInformedNN:
    ...
    def __init__(self, x0, u0, x1, layers, t0, dt, lb, ub, q):
...
if __name__ == "__main__":
    ...
    data = scipy.io.loadmat('data/heat1D_discrete.mat')
    ...
    model = PhysicsInformedNN(x0, u0, x1, layers, t0, dt, lb, ub, q)
    model.train(epochs)
    ...
    savefig('figures/1Dheat_discrete', crop=False)